...
bindkey '^H' backward-kill-word                   # delete word backward
...
update_prompt() {
    PS1="%F{%(#.red.blue)}%n:%1~%F{reset}$(parse_git_branch) %(!.#.$) "
}
...
PATH=$PATH:/home/d093w1z/.local/bin
PATH=$PATH:/home/d093w1z/bin
PATH=$PATH:/snap/bin
